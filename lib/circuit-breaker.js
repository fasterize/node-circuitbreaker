...
var CircuitBreaker = module.exports = function (func, options) {
  ...
  this._decayFunc = this.options.decayFunction;
  this._decayDelay = this.options.decayDelay || 1000;

  if (this._decayFunc) {
    this.scheduleDecayFunc();
  }
...
CircuitBreaker.prototype.scheduleDecayFunc = function () {
  var self = this;
...
// This method regularly lower the number of failures
CircuitBreaker.prototype.runDecayFunc = function () {
  if (this.isClosed() && this._numFailures > 0) {
    this._numFailures = this._decayFunc(this._numFailures);
  }
};
